...
// 		String fileDir = ownerName + "_" + fileName;
// 		MockMultipartFile mockMultipartFile =
// 			new MockMultipartFile("file", fileName, "text/plain", "test data".getBytes());
// 		FileUploadRequest request = new FileUploadRequest(fileName, ownerName, mockMultipartFile);
//
...
//
// 		// when
// 		FileServiceResponse response = fileService.uploadFile(ownerName, request);
//
// 		// then
...
// 		// given
// 		String fileName = "test.txt";
// 		String ownerName = "user_1"; // 유효하지 않은 유저 이름
// 		MockMultipartFile mockMultipartFile =
// 			new MockMultipartFile("file", fileName, "text/plain", "test data".getBytes());
// 		FileUploadRequest request = new FileUploadRequest(fileName, ownerName, mockMultipartFile);
//
...
// 			fileService.uploadFile(ownerName, request);
// 		});
// 	}
//
